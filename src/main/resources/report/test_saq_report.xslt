...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/Report">
        <xsl:variable name="contentFont"
                      select="contentFont"/>
        <fo:root font-family="{$contentFont}" font-size="12pt">
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell>
                                    <fo:table width="100%" margin-bottom="5pt" table-layout="fixed">
                                        ...
                                        <fo:table-column column-width="30%"/>
                                        <fo:table-body>
                                            <fo:table-row font-size="13pt" background-color="{$table_header_bg_color}" color="{$front_color}" font-weight="bold">
                                ...
                                <fo:table-row>
                                    ...
                                    <fo:table-cell>
                                        <fo:table width="100%" margin-bottom="5pt" table-layout="fixed">
                                            ...
                                            <fo:table-header font-size="13pt">
